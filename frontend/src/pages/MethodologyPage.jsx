            ...
            <div className="glass-panel" style={{ padding: '2.5rem' }}>
                ...
                <ul style={{ paddingLeft: '1.5rem', marginBottom: '2rem', color: 'var(--color-text-secondary)', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                    <li>
                        ...
                        with pro-social use cases in Health-tech, Agri-Tech, Ed-Tech, Justice-Tech, AI resources, and similar fields were prioritised.
                    </li>
                    <li>
                ...
                <p style={{ fontSize: '1.1rem', color: 'var(--color-text-secondary)' }}>
                    ...
                    No primary research was conducted; instead, existing verified data points, recognised deployments,
